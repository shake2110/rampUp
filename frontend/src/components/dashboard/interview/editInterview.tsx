    ...
    <div className=" h-screen z-[10] mx-2">
      <div className="flex flex-col bg-gray-200 rounded-md min-h-[120px] p-2 pl-4">
        ...
        <div className="flex flex-row justify-between mt-3">
          <p className="mb-1 ml-2 font-medium">Target Role / Interview Name</p>
        </div>
        <input
          type="text"
          value={interview?.name || ""}
          disabled
          className="h-fit mt-1 ml-2 py-2 border-2 rounded-md w-[75%] px-2 border-gray-400 bg-gray-100"
        />
        ...
        />
        <p className="mt-3 mb-1 ml-2 font-medium">Interview Context / Objective</p>
        <textarea
          value={objective}
          className="h-fit mt-3 ml-2 py-2 border-2 rounded-md w-[75%] px-2 border-gray-400"
