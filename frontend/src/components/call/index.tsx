        ...
        <Card className="h-[88vh] rounded-lg border-2 border-b-4 border-r-4 border-black text-xl font-bold transition-all  md:block dark:border-white ">
          <div>
            ...
            {!isStarted && !isEnded && !isOldUser && (
              <div
                className="w-fit min-w-[340px] max-w-[420px] mx-auto mt-2 border border-indigo-200 rounded-md m-2 bg-slate-50 flex flex-col"
              ...
              >
                <div className="overflow-y-auto flex-1 p-3">
                  ...
                  <div className="p-2 font-normal text-sm mb-3 whitespace-pre-line">
                    {interview?.description}
                    <p className="font-bold text-sm mt-2">
                      Ensure your volume is up and grant microphone access when prompted. Please
                      make sure you are in a quiet environment.
                      {"\n\n"}You will be asked to explain concepts. The AI will act as a curious
                      student.
                    ...
                    <div className="flex flex-col gap-2 justify-center">
                      ...
                      {interview.is_resume_based && (
                        <div className="w-[75%] mx-auto mb-2">
                          <p className="text-xs font-semibold mb-1">Upload your resume (PDF)</p>
                          <p className="text-xs text-gray-400 mb-1">
                            Used to personalize teaching scenarios — not for a resume walkthrough.
                          </p>
                          <FileUpload
                ...
                <div className="flex flex-row p-3 gap-2 justify-center border-t border-indigo-100 bg-slate-50 rounded-b-md sticky bottom-0">
                  <Button
                  ...
                  >
                    {!Loading ? "Start Teaching Assessment" : <MiniLoader />}
                  </Button>
                  <AlertDialog>
                    <AlertDialogTrigger>
                      <Button
                ...
                <div className="border-x-2 border-grey w-[50%] my-auto min-h-[70%]">
                  <div className="flex flex-col justify-evenly">
                    ...
                    <div className="flex flex-col mx-auto justify-center items-center align-middle">
                      ...
                      />
                      <div className="font-semibold">Tutor Screener</div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <div className="p-2 font-normal text-base mb-4 whitespace-pre-line">
                    ...
                    <p className="text-lg font-semibold text-center">
                      {isStarted
                        ? "Thank you for completing the teaching assessment!"
                        : "Thank you very much for your time."}
                    </p>
                    <p className="text-center text-sm mt-2">
                      Our team will review your session and be in touch.
                    </p>
